package com.tapianadia.literatura.principal;

import com.alura.literatura.model.*;
import com.alura.literatura.repository.LibrosRepository;
import com.tapianadia.literatura.service.ConsumoAPI;
import com.tapianadia.literatura.service.ConvierteDatos;
import com.tapianadia.literatura.model.*;
...
public class Principal {
    ...
    public void mostrarMenu(){
        ...
        while (opcion != 0){
            ...
            var menu = """
                    ****************************************************
                    Bienvenido/a a LiTeRaTuRa, seleccione una opción:
                    ****************************************************
    ...
    private DatosLibros obtenerLibroAPI(){
        ...
        // Filtramos por el título del libro
    ...
    //Buscamos los libros por titulo
    private void buscarLibroPorTitulo(){
        ...
        if (datosLibro != null) {
            ...
            try {
                ...
                System.out.println("Este libro ya fue registrado. Intente con otro.\n");
            }
        } else {
    ...
    //Mostramos los autores registrados
    ...
    // Mostramos los autores vivos en un determinado año
    private void listarAutoresVivosEnUnDeterminadoAno() {
        ...
        if (autoresVivos.isEmpty()) {
            System.out.println("No hay autores vivos en el año indicado...\n");
            return;
        }
